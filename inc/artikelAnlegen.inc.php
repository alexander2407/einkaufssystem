...
if (!empty($_GET['artikelname'])) {
    ...
    <form class="form-horizontal" method="GET" action="index.php">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text"  name="einkaufspreis" class="form-control" id="einkaufspreis"  required="" min="1">
            </div>
        </div>
        <!--<div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="mindestbestand" class="form-control" id="mindestbestand"  required="" min="0">
            </div>
        </div>
        <!--<div class="form-group">
